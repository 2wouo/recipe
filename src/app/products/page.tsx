      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div key={product.id} className="flex items-center justify-between rounded-sm border border-zinc-800/50 bg-zinc-900/30 p-3 pl-4 hover:bg-zinc-900/60 transition-colors group">
                ...
                <h4 className="font-bold text-zinc-200">{product.name}</h4>
                ...
                className="text-zinc-600 hover:text-red-500 transition-colors p-2 opacity-0 group-hover:opacity-100 md:opacity-100"
                >
                <Trash2 size={16} />
                </button>
            </div>
